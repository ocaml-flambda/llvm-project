...
/// by replacing the owned value via set().
///
/// All references are always initialized with a value and should not be null
/// after construction.
///
/// INVARIANTS:
...
public:
  ...
  /// Update the value
  void set(std::unique_ptr<T> value) { m_value = std::move(value); }
